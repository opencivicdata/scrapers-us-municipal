...
class MountainviewEventsScraper(LegistarAPIEventScraperZip, Scraper):
    def scrape(self):
...
# class MountainviewEventsScraper(LegistarAPIEventScraperZip, Scraper):
#     BASE_URL = 'https://webapi.legistar.com/v1/mountainview'
#     WEB_URL = "https://mountainview.legistar.com/"
#     EVENTSPAGE = "https://mountainview.legistar.com/Calendar.aspx"
#     TIMEZONE = "America/Los_Angeles"
    ...
    #         status = 'cancelled'
    #     elif comment in ('meeting reconvened',
    #                      'reconvened meeting',
    #                      'recessed meeting',
    #                      'reconvene meeting',
    #                      'rescheduled hearing',
